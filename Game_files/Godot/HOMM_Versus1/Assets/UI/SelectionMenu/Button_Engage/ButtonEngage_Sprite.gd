...
var PassiveButton = load("res://Assets/UI/SelectionMenu/Button_Engage/ENGAGE_BUTTON.png")
var PressedButton = load("res://Assets/UI/SelectionMenu/Button_Engage/ENGAGE_BUTTON_Pressed.png")
