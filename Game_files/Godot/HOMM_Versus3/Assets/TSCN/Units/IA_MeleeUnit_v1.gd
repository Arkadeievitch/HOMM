...
#	var onMapEnemies_scores = 			temp_Array[3]
	...
	var onRangeEnemies_counters = 		temp_Array[6]
	var onRangeEnemies_scores = 		temp_Array[7]
	
	var Tiles = 						temp_Array[8]
	var Tiles_number : int = 			temp_Array[9]
	var Tiles_scores = 					temp_Array[10]
	# init --- Fin
...
#	onMapEnemies_scores = 	temp_Array[3]
	...
	if onRangeEnemies_number > 0 :
		...
		onRangeEnemies_scores = temp_Array
...
func initialize():
	...
	var Tiles = 				[]
	var Tiles_number : int = 	0
	var Tiles_scores = 			[]
	
	return [onMapEnemies, onMapEnemies_number, onMapEnemies_counters, onMapEnemies_scores,
			onRangeEnemies, onRangeEnemies_number, onRangeEnemies_counters, onRangeEnemies_scores,
			Tiles, Tiles_number, Tiles_scores]
...
func retrieveOnRangeEnemies(Tiles, Tiles_number, 
	...
	return [onRangeEnemies, onRangeEnemies_number, onRangeEnemies_counters, onRangeEnemies_scores]
